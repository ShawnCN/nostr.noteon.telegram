...
import './Dialog.css';
import { TChat, TChatList, TStyle } from '../../react-app-env';
...
class Dialog extends Component<IPropsDialog, IStateDialog> {
  static defaultProps = {
    hidden: false,
    showSavedMessages: true,
  };
  static contextMenuId;
  dialog: React.RefObject<unknown>;
  ...
  render() {
    ...
    const { contextMenu, left, top, canToggleArchive, canTogglePin, canMute } =
      this.state;

...
class DialogListItem extends React.Component<IPropsDialogListItem,IStateDialogListItem> {
...
class DialogsList extends React.Component<IPropsDialogsList,IStateDialogsList> {

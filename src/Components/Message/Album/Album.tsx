...
interface IPropsAlbum {
    messageIds:number[]
    chatId:number
    displaySize:number
    showTail:boolean, 
    source:any
    showUnreadSeparator:any, 
    showTitle:boolean, 
    showDate:boolean, 
}


interface IStateAlbum {
    emojiMatches:any
    selected:any
    highlighted:any
...
class Album extends React.Component<IPropsAlbum,IStateAlbum> {
    ...
    state = { } as IStateAlbum;
    handleDateClick: any;
    handleSelectChat: any;
    handleMouseOver: MouseEventHandler<HTMLDivElement> | undefined;
    handleMouseOut: MouseEventHandler<HTMLDivElement> | undefined;
    handleAnimationEnd: AnimationEventHandler<HTMLDivElement> | undefined;
    handleOpenContextMenu: MouseEventHandler<HTMLDivElement> | undefined;
    handleMouseDown: MouseEventHandler<HTMLDivElement> | undefined;

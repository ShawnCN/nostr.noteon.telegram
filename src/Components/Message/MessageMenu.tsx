...
interface IStateMessageMenu {
    dialog:any
    confirmStopPoll:boolean
    contextMenu:boolean
}

class MessageMenu extends React.PureComponent<IPropsMessageMenu,IStateMessageMenu> {
    state = {
        confirmStopPoll: false
    } as IStateMessageMenu;

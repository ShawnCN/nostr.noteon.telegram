...
import KeyboardManager, {
  KeyboardHandler,
} from './Components/Additional/KeyboardManager';
...
class TelegramApp extends Component<IPropsMainPage, IStateMainPage> {
  ...
  componentDidMount() {
    ...
    AppStore.on(
      'clientUpdateTdLibDatabaseExists',
      this.onClientUpdateTdLibDatabaseExists
    );
  ...
  onUpdateAuthorizationState = (update) => {
    ...
    console.log('onUpdateAuthorizationState3333333333333')
